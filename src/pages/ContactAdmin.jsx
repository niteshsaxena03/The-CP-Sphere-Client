      ...
      <div className="bg-gray-800 p-10 rounded-lg shadow-lg w-full max-w-md text-center">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="flex items-center">
              <img
                ...
                alt="LinkedIn Icon"
                className="h-20 w-25 mr-6 rounded-lg" // Increased icon size
              />
          ...
          >
            <span className="flex items-center">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwYG4azEl9wGw5TJHa2ct7hKic_VsexIUDlQ&s" // Replace with actual Twitter icon link
                alt="Twitter Icon"
                className="h-20 w-25 mr-6 rounded-lg" // Increased icon size
              />
