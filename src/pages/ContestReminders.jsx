...
const ContestReminders = () => {
  ...
  return (
    <div className="bg-black min-h-screen p-5 md:p-10 flex flex-col items-center">
      <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8 w-full max-w-lg text-center border border-green-500">
        ...
        contestDetails.map((contest, index) => {
          ...
          if (timeDiff > 0) {
            return (
              <div
                key={index}
                className="bg-gray-700 p-6 rounded-lg shadow-lg w-full max-w-lg mb-4 text-center transition-transform transform hover:scale-105"
              >
                <h2 className="text-2xl font-semibold text-white mb-2">
                  {contest.name}
                </h2>
                <p className="text-white mb-4">
                  Next Contest: {contest.day} at {contest.time}
                </p>
